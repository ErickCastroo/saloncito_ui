...
function InfoContainer() {
  return (
    <div className='bg-secondary text-secondary w-full h-5/6 md:w-1/2 rounded md:rounded-none md:rounded-tr md:rounded-br relative flex flex-col justify-center items-center overflow-y-auto py-4'>
